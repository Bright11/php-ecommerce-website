...
<input type="hidden" class="form-control" name="product" value="<?= $allItems; ?>" readonly>

<input type="hidden" class="form-control" name="price" value="<?= number_format($grand_total,2) ?>" readonly>
<div class="form-group">
...
<input type="hidden" class="form-control" name="customer_ip" value="<?php echo $ip;?>">
<input type="hidden" class="form-control" name="date" value="<?php echo date("Y-m-d"); ?>" readomly>

<div class="form-group">
<input type="submit" class="form-control" name="submit" value="Submit" style="background: #3cbc8d; letter-spacing: 2px;font-size: 20px;font-weight: 30px;color: white;text-transform: uppercase;">
</div>
</form>
</div>
</div>
